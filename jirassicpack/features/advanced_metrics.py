...
from jirassicpack.utils import get_option, validate_required, validate_date, error, spinner, safe_get, build_context, write_markdown_file, require_param, info, render_markdown_report
...
def advanced_metrics(jira: Any, params: Dict[str, Any], user_email=None, batch_index=None, unique_suffix=None) -> None:
    ...
    with open(filename, 'w') as f:
        f.write(content)
    logger.info(f"[advanced_metrics] Metrics report written to {filename}", extra=context) 